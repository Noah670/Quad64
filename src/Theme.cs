...
namespace Quad64.src
{
    class Theme
    {
        ...
        public static void SetDefaultColors()
        {
            ...
            SCRIPTDUMPS_BACKGROUND = Color.FromArgb(255, 255, 255);
            SCRIPTDUMPS_TEXT = Color.FromArgb(0x00, 0x00, 0x00);
            SCRIPTDUMPS_OPTIONS_BACKGROUND = Color.FromArgb(255, 255, 255);

            SCRIPTDUMPS_LEVEL_TEXTBOX_BACKGROUND = Color.FromArgb(255, 255, 255);
            ...
            SCRIPTDUMPS_GEOLAYOUT_TEXTBOX_BACKGROUND = Color.FromArgb(255, 255, 255);
            ...
            SCRIPTDUMPS_FAST3D_TEXTBOX_BACKGROUND = Color.FromArgb(255, 255, 255);
            ...
            SCRIPTDUMPS_BEHAVIOR_TEXTBOX_BACKGROUND = Color.FromArgb(255, 255, 255);
